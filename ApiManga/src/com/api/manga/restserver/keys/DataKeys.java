...
public class DataKeys {
	...
	public final static String mangaEdenApiMangaListURI = "https://www.mangaeden.com/api/list/";
	public final static String mangaEdenApiMangaListURISplitPage = "?p=";
	public final static String mangaEden_Language_English="0";
	public final static String mangaEden_Language_Italian="1";
	public final static String mangaEdenApiMangaURI = "https://www.mangaeden.com/api/manga/";
	public final static String mangaEdenApiChapterURI = "https://www.mangaeden.com/api/chapter/";
	public final static String mangaEdenJson_mangaName ="a";
	public final static String mangaEdenJson_mangaCategory ="c";
	public final static String mangaEdenJson_mangaImage ="im";
	public final static String mangaEdenJson_mangaTitle ="t";
	public final static String mangaEdenJson_mangaID ="i";
	public final static String mangaEdenJson_mangaLastChapterDate ="ld";
	...
	public final static String mangaEdenJson_long_images ="images";
